<template>
	...
	<div>
		...
		<el-text class="mx-1"
						 type="primary">Primary</el-text>
		<el-text class="mx-1"
						 type="success">Success</el-text>
		<el-text class="mx-1"
						 type="info">Info</el-text>
		<el-text class="mx-1"
						 type="warning">Warning</el-text>
		<el-text class="mx-1"
						 type="danger">Danger</el-text>
		<div style="max-width: 600px">
			<el-alert title="Primary alert"
								type="primary" />
...
const OnLayoutChange = () => {
	nextTick(() => {
		Object.keys(ruleForm.value).forEach((key) => {
			if (appSettings.value.hasOwnProperty(key)) {
				appSettings.value[key] = ruleForm.value[key];
			}
		});
...
const OnCommitColor = (color) => {
	if (ruleForm.value[setColor.value] !== null && ruleForm.value[setColor.value] !== undefined) {
		...
		if (elColors[setColor.value] !== null && elColors[setColor.value] !== undefined) {
			...
			console.info(property[setColor.value], setColor.value)
